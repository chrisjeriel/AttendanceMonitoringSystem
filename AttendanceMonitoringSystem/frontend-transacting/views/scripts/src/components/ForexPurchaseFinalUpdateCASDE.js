...
var ForexPurchaseFinalUpdateCASDE = React.createClass({
    render: function() {
        return(
            <TransactionContainer title='FOREX PURCHASE FINAL UPDATE on Cash Acceptance/Settlement'>
                <form>
                    <div className="row">
...
module.exports = ForexPurchaseFinalUpdateCASDE;
