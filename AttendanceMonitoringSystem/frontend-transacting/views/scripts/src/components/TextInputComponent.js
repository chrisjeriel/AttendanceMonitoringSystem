...
var TextInputComponent = React.createClass({
    ...
    componentDidMount: function(){
        if (this.props.mask != null) {
            $('#text-input').mask(this.props.mask)
        }
                    ...
                    <label className='col-md-1'>:</label>

                                {
                                    ...
                                    <div className={this.props.inputLength}>
                                        <input className='input' type={this.props.inputType} id='text-input'
                                            ref='textinput' disabled={!this.state.editMode} onChange={this.props.onChange} onKeyDown={this.props.onKeyDown} maxLength={this.props.maxLength} style={{textAlign: this.props.inputTextAlign}} />
                                    </div>
                                    :
                                        <div className={this.props.inputLength} >
