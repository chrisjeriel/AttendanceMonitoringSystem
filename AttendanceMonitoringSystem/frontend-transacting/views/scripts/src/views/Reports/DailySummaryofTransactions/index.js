...
var DailySummaryofTransactions = React.createClass({
    contextTypes: {
    ...
    getInitialState: function () {
        ...
        return {
            ...
            confirm_message: 'View Screen Layout for ' + category.toUpperCase() + ' ' + transaction_type.toUpperCase() + ' Transactions, Continue?',
    ...
    showPrinterMessage: function () {
        ...
        this.setState({
            confirm_message: 'Proceed to Printing of ' + this.state.category.toUpperCase() + ' ' + this.state.transaction_type.toUpperCase() + ' Transactions.',
    ...
    confirmProceedtoPrinting: function (res) {
        ...
        if (res) {
            //print
            alert('Printing ' + this.state.category.toUpperCase() + ' ' + this.state.transaction_type.toUpperCase() + ' Transactions for the Day Successful');
        }
    ...
    render: function() {
        ...
        if (this.state.confirm_message) {
            return (
                <TransactionContainer title={category + ' ' + transaction_type + ' TRANSACTIONS FOR THE DAY'}>
            ...
            <TransactionContainer title={category + ' ' + transaction_type + ' TRANSACTIONS FOR THE DAY'}>
                <div className="row text-center">
                    <div className="col-md-2 col-md-offset-10">
                        DAILY {transaction_type} TRANSACT <br/>
...
module.exports = DailySummaryofTransactions;
