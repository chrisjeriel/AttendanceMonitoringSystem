...
public class T0104 extends TModelBase{
	...
	for(String key: map.keySet()){
		switch(key){
			...
			case "CURR_CODE":
				...
				break;
			case "MIN_AMNT":
				this.setMinAmnt(BigDecimal.valueOf(Long.valueOf(map.get(key))));
				break;
			case "PABV_LIM":
				this.setPabvLim(BigDecimal.valueOf(Long.valueOf(map.get(key))));
				break;


			case "SABV_LIM":
				this.setSabvLim(BigDecimal.valueOf(Long.valueOf(map.get(key))));
				break;
