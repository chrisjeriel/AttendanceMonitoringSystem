...
import java.math.BigDecimal;
 ...
 public class T0900 extends TModelBase {
	...
	public String toString() {
		return "T0900 [id=" + id + ", trdrFi=" + trdrFi + ", refNmbr=" + refNmbr + ", mcSerNo=" + mcSerNo + ", cLName="
				+ cLName + ", cFName=" + cFName + ", cMName=" + cMName + ", phpAmt=" + phpAmt + "]";
