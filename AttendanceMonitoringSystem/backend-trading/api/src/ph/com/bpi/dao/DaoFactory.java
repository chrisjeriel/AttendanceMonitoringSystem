...
public class DaoFactory{
	...
	public static MembersDAO getMembersDAO(){
		MembersDAO dao = new MembersDAOImpl(sessionFactory);

		return dao;
	}
	public static SessionsDAO getSessionsDAO(){
		SessionsDAO dao = new SessionsDAOImpl(sessionFactory);
		
		return dao;
	}
	public static AttendancesDAO getAttendancesDAO(){
		AttendancesDAO dao = new AttendancesDAOImpl(sessionFactory);
		
		return dao;
	}
	
	public static TMEMBERSDAO getTMEMBERSDAO(){
		TMEMBERSDAO dao = new TMEMBERSDAOImpl(sessionFactory);
		return dao;
	}
	...
	public static T0220DAO getT0220DAO(){
		...
		public static T0138DAO getT0138DAO(){
			T0138DAO dao = new T0138DAOImpl(sessionFactory);
			return dao;
			}
		...
		public static T0309DAO getT0309DAO(){
		T0309DAO dao = new T0309DAOImpl(sessionFactory);
		return dao;
		}
		...
		public static T0313DAO getT0313DAO(){
		T0313DAO dao = new T0313DAOImpl(sessionFactory);
		return dao;
		}
	...
	public static FXMENUDAO getFXMENUDAO(){
	FXMENUDAO dao = new FXMENUDAOImpl(sessionFactory);
	return dao;
	}
	
	
	public static FXMENUDDAO getFXMENUDDAO(){
	FXMENUDDAO dao = new FXMENUDDAOImpl(sessionFactory);
	return dao;
	}
	
	
	public static FXMENUWDAO getFXMENUWDAO(){
	FXMENUWDAO dao = new FXMENUWDAOImpl(sessionFactory);
	return dao;
	}
	
	
	public static FXMCRODAO getFXMCRODAO(){
	FXMCRODAO dao = new FXMCRODAOImpl(sessionFactory);
	return dao;
	}
	
	
	public static STATTEMPDAO getSTATTEMPDAO(){
		STATTEMPDAO dao = new STATTEMPDAOImpl(sessionFactory);
	return dao;
	}
	
	
	public static FXPARAMDAO getFXPARAMDAO(){
		FXPARAMDAO dao = new FXPARAMDAOImpl(sessionFactory);
	return dao;
	}
	
	
	public static FXREFDAO getFXREFDAO(){
		FXREFDAO dao = new FXREFDAOImpl(sessionFactory);
	return dao;
	}
}
