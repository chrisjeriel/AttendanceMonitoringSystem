  ...
  (0, _createClass3.default)(DataTablesHeaderColumn, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          order = _props.order,
          other = (0, _objectWithoutProperties3.default)(_props, ['children', 'className', 'columnNumber', 'hoverable', 'onClick', 'onHover', 'onHoverExit', 'style', 'tooltip', 'tooltipStyle', 'sortable', 'sorted', 'order']);
